...
public class SaveLoad_CollectionTypeTests {
    ...
    public void saveLoad_Map_ComplexTypeToComplexType() throws NoSuchFieldException {
        ...
        String className = ComplexType.class.getName();
        Map<ComplexType, ComplexType> loadedValue = (Map<ComplexType, ComplexType>) file.get(ClassTree.parseFromString("java.util.HashMap<" + className + "," + className + ">"), savedValueKey);
