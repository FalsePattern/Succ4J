...
import com.github.falsepattern.succ4j.parsinglogic.nodes.MultiLineStringNode;
import com.github.falsepattern.succ4j.parsinglogic.types.BaseTypes;
import com.github.falsepattern.succ4j.parsinglogic.types.CollectionTypes;
...
import com.github.falsepattern.succ4j.parsinglogic.types.ComplexTypeShortcuts;
...
public class NodeManager {
    ...
    public static <T> void setNodeData(Node node, Object data, ClassTree<?> type, FileStyle style) {
        ...
        if (type.type.equals(String.class) && (ParsingLogicExtensions.containsNewLine(dataAsString) || node.getChildNodes().size() > 0)) {
